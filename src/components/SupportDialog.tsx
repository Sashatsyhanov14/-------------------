    ...
    <Dialog open={open} onClose={onClose} className="relative z-50">
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <Dialog.Panel className="w-full max-w-md rounded-2xl border border-neutral-700 bg-neutral-900/80 p-6 shadow-2xl">
          <Dialog.Title className="text-xl font-semibold mb-2">Поддержка Estate AI</Dialog.Title>
          <p className="text-muted-foreground">Нужна помощь или консультация? Отвечаем ежедневно с 10:00 до 19:00.</p>
          <p className="mt-2">
          ...
          <div className="mt-4 flex justify-end">
            <button className="btn btn-primary btn--sm" onClick={onClose}>Понятно</button>
          </div>
        </Dialog.Panel>
      </div>
    </Dialog>
