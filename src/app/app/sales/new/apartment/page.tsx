      ...
      <div className="px-4 md:px-6 space-y-8">
        <form onSubmit={submit} className="space-y-8">
          ...
          <div className="fixed bottom-0 left-0 right-0 p-4 bg-neutral-950/90 backdrop-blur-lg border-t border-neutral-800 md:static md:bg-transparent md:border-0 md:p-0 z-40">
            ...
            <Button
              type="submit"
              disabled={loading || !form.price || !form.city || !form.address}
              className={`w-full py-4 text-base font-semibold shadow-xl transition-all ${loading || !form.price || !form.city || !form.address
